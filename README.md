...
- 基础功能（当前设定 聊天回复率 1%，随机复读率 1%，突然抽风率 0‰）
...
- 好康的
  ...
  - [x] `来图 或 图来`
    - 在最大限度的尺度下让小夜发一张合法的色图
  - [x] `福利姬`
    - 在无限度的尺度下让小夜发一张非法的福利姬色图，危险注意！
  - [x] `来点二次元`
    - 在普通限度的尺度下让小夜发一张好康的的二次元图

---

## ✨ web 网页控制台功能与特性 Web end Features
...
本项目使用 GPLv3 开源协议，一经使用则视为同意该协议，意味着你可以原封不动地运行本项目，并向你的用户提供服务。但如果对项目进行了任何修改，则需要 fork 本仓库并开源，至少需要将你修改后的版本对你的用户开源。出现的一切事故情况，请自行处理。禁止任何形式的倒卖转售，如有任何疑问、建议或者需要联系我，请加 QQ 群 120243247：点击链接加入群聊【星野夜蝶 粉丝群】：https://jq.qq.com/?_wv=1027&k=ovqyydCe
